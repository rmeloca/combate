...
(define (alteraLista lista posicao elemento index novaLista)
  (cond
    ...
    ((not (eq? posicao index)) (alteraLista (cdr lista) posicao elemento (+ index 1) (concatenaLista novaLista (list(car lista)))))
    ((eq? posicao index) (alteraLista (cdr lista) posicao elemento (+ index 1) (concatenaLista novaLista (list elemento))))
    )
)
